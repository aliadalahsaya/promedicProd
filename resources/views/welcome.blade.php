...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-7 col-12">
                        ...
                        <ul class="top-contact">
                            ...
                            <li><i class="fa fa-envelope"></i><a href="promedic@gmail.com">promedic@gmail.com</a></li>
                        </ul>
                        <!-- End Top Contact -->
                    </div>
                </div>
                ...
                <div class="inner">
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-12">
                            <div class="get-quote">
                                <a href="appointment.html" class="btn">Order an Ambulance</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="single-slider" style="background-image:url('img/slider2.png')">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="text">
                                <h1>We Provide <span>Ambulance</span> Services That You Can <span>Trust!</span></h1>
                                <p>Di isi dengan penjelasan singkat tentang promedic</p>
                                <div class="button">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="content">
                        <h2>Do you need an Ambulance for an Emergency? Call @ 1234 56789</h2>
    ...
    <!-- Niceselect JS -->
    <script src="public/js/niceselect.js"></script>
    <!-- Tilt Jquery JS -->
    ...
    <!-- Steller JS -->
    <script src="public/js/steller.js"></script>
    <!-- Wow JS -->
